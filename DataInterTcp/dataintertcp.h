#ifndef DATAINTERTCP_H
#define DATAINTERTCP_H

#include "DataInterTcp_global.h"
#include "datainterchangeinterface.h"
#include "tcpserver.h"

class DATAINTERTCP_EXPORT DataInterTcp:public DataInterchangeInterface
{
    Q_OBJECT
...
public:
    DataInterTcp(QObject *parent=nullptr);
    ~DataInterTcp()Q_DECL_OVERRIDE;
...
private:
    ...
    ///
    /// \brief analyticalData 写入重量数据
    /// \param data
    /// \return
    ///
    QString analyticalData(QString data);
